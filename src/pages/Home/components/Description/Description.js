...
export const DescriptionSection = ({ fullpageApi }) => {
				...
				<div className='flex flex-row w-full max-w-screen-xl'>
					<div className='flex items-center justify-center left-side'>
						<div className='flex flex-col time-line'>
							{active >= 1 ? (
								<img src={Active} alt='active-icon' className='icon icon-1' />
							) : (
								<img src={Inactive} alt='active-icon' className='icon icon-1' />
							)}
							{active >= 2 ? (
								<img src={Active} alt='active-icon' className='icon icon-2' />
							) : (
								<img src={Inactive} alt='active-icon' className='icon icon-2' />
							)}
							{active >= 3 ? (
								<img src={Active} alt='active-icon' className='icon icon-3' />
							) : (
								<img src={Inactive} alt='active-icon' className='icon icon-3' />
							)}
							{active >= 4 ? (
								<img src={Active} alt='active-icon' className='icon icon-4' />
							) : (
								<img src={Inactive} alt='active-icon' className='icon icon-4' />
							)}
						...
						{active === 1 ? (
							<div id={'main-frame__content-1'} className='main-frame__content'>
								...
								<div className='mt-6 expand-content'>
									...
									invented a way of creating human mutation through the impact of a virus. 4W wanted
									to apply this technology to create a new human race, superior in intelligence,
									physicality, and even supernatural abilities.
								</div>
							</div>
						) : null}
						{active === 2 ? (
						...
						{active === 3 ? (
							<div id={'main-frame__content-3'} className='main-frame__content'>
								...
								<div className='mt-6 expand-content'>
									...
									quickly collapsed. The world fell into chaos. Reports of hybrids began to appear.
									Those were half human half animals with superior speed and physical strength but
									their consciousness and intelligence were impaired.
								</div>
							</div>
						) : null}
						{active === 4 ? (
